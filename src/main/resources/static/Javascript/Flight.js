...
/* ----- TYPING EFFECT ----- */
   var typingEffect = new Typed(".typedText",{
      strings : ["Flight Reservation Application","Based on Spring Boot Monolithic Architecture"],
      loop : true,
      typeSpeed : 100, 
      backSpeed : 50,
      backDelay : 3000
...
/* ----- CHANGE ACTIVE LINK ----- */
  ...
  function FlightProjectGitHub(){
    window.location.href = '/flightProjectGithub';
  }
